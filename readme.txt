...
* Tags: photos, pinterest, pins, pinboard, photostream, pictures, widget, sidebar, gallery, lightbox
...
**Stylish and compact plugin for displaying Pinterest images in a sidebar, post, or any custom post type.
...
**Alpine Photo Tile for Pinterest Features:**

* Display type: Carousel, Cascade, Floor, Wall, Fift, Bookshelf, Gallery, Vertical, Window
* No Shortcode management. Generate on-the-fly.
* Display Pinterest images in a sidebar, post, or any custom post type
...
= 1.3.1 =
* Added option for Equal height
* Added option to set autoplay speed
* Fixed Carousel option for widget
* Responsive fixes
...
= 1.2.9 =
* Fixed all code to work with WP 5.4

= 1.2.8 =
* Skipped due to issues with commit
